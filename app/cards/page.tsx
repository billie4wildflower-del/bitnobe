  ...
  return <main className="min-h-screen bg-[#f5f7f3] text-[#14241f]">
    <header className="border-b border-[#dbe2da] bg-white/90">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
        <Link href="/business-banking" className="flex items-center gap-3 font-semibold tracking-tight"><BrandMark inverse className="bg-[#10251f] text-[#d9f06c]" />BitNobe cards</Link>
        <a href="#card-options" className="inline-flex items-center rounded-full bg-[#10251f] px-4 py-2 text-sm font-semibold text-white hover:bg-[#1b382f]">Set up a credit card</a>
      </div>
    </header>
    <section className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:py-20">
      ...
      <div id="card-options" className="mt-12 grid scroll-mt-24 gap-5 lg:grid-cols-2">
