...
export default function BusinessBankingPage() {
  return (
    <main className="min-h-screen bg-[#f5f7f3] text-[#14241f]">
      ...
      <footer className="bg-[#10251f] text-white/60">
        <div className="mx-auto max-w-7xl px-5 py-14 sm:px-8">
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-[1.4fr_repeat(4,1fr)]">
            <div><Link href="/business-banking" className="flex items-center gap-3 text-white"><span className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#d9f06c] text-[#10251f]"><Landmark className="h-5 w-5" /></span><span className="font-semibold tracking-tight">BitNobe</span></Link><p className="mt-5 max-w-xs text-sm leading-6">Modern business banking tools for teams that want more control over their money.</p><div className="mt-5 flex items-center gap-2 text-xs text-white/45"><ShieldCheck className="h-4 w-4 text-[#d9f06c]" />Security-led member banking</div></div>
            <div><p className="text-sm font-semibold text-white">Solutions</p><div className="mt-4 space-y-3 text-sm"><a href="#solutions" className="block hover:text-white">Business checking</a><a href="#solutions" className="block hover:text-white">Payments</a><a href="#security" className="block hover:text-white">Team access</a><a href="#downloads" className="block hover:text-white">Downloads</a></div></div>
            <div><p className="text-sm font-semibold text-white">Company</p><div className="mt-4 space-y-3 text-sm"><a href="#security" className="block hover:text-white">Why BitNobe</a><Link href="/sign-up" className="block hover:text-white">Get started</Link><Link href="/sign-in" className="block hover:text-white">Member sign in</Link><Link href="/support" className="block hover:text-white">Contact us</Link></div></div>
            <div><p className="text-sm font-semibold text-white">Support</p><div className="mt-4 space-y-3 text-sm"><Link href="/support" className="block hover:text-white">Help center</Link><a href="#downloads" className="block hover:text-white">App downloads</a><Link href="/support" className="block hover:text-white">Report an issue</Link><a href="mailto:support@bitnobe.example" className="block hover:text-white">Email support</a></div></div>
            <div><p className="text-sm font-semibold text-white">Legal and security</p><div className="mt-4 space-y-3 text-sm"><a href="#security" className="block hover:text-white">Security overview</a><a href="#" className="block hover:text-white">Privacy notice</a><a href="#" className="block hover:text-white">Terms of service</a><a href="#" className="block hover:text-white">Accessibility</a></div></div>
          </div>
