...
export default function BusinessBankingPage() {
  return (
    <main className="min-h-screen bg-[#f5f7f3] text-[#14241f]">
      <section className="segment-surface relative overflow-hidden text-white">
        <div className="absolute inset-0 opacity-35 [background-image:linear-gradient(rgba(255,255,255,.06)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,.06)_1px,transparent_1px)] [background-size:52px_52px]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(174,255,96,0.2),transparent_32%)]" />
        <div className="absolute left-[8%] top-[18%] h-20 w-20 rotate-[-14deg] rounded-[22px] border border-[#c8ff6c]/30 bg-black/20 opacity-75 segment-glow" />
        <div className="absolute right-[10%] top-[20%] h-12 w-12 rounded-[14px] border border-[#c8ff6c]/30 bg-black/20 opacity-75 segment-glow" />
        <div className="absolute bottom-[12%] left-[22%] h-20 w-20 rotate-[18deg] rounded-[22px] border border-[#c8ff6c]/30 bg-black/20 opacity-70 segment-glow" />
        <div className="absolute bottom-[14%] right-[14%] h-20 w-20 rotate-[-10deg] rounded-[22px] border border-[#c8ff6c]/30 bg-black/20 opacity-75 segment-glow" />
        <div className="relative mx-auto max-w-7xl px-5 sm:px-8">
          <nav className="flex h-20 items-center justify-between border-b border-white/10">
            <Link href="/business-banking" className="flex items-center gap-3"><BrandMark inverse className="h-10 w-10" /><span className="font-semibold tracking-tight">BitNobe <span className="font-normal text-white/55">for business</span></span></Link>
